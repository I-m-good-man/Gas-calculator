...
class CoordWidget(QWidget):
    ...
    def __init__(self, id_widget: int, parent=None):
        ...
        self.base_gases = ['H: 1,008', 'H2: 2,016', 'NH3: 17,031', 'CH4: 16,04', 'CO: 28,01', 'H2O: 18,016', 'CO2: 44,009', 'N2: 28,016', 'O2: 31,998', 'He: 4,003', 'Ar: 39,944', 'Ne: 20,183', 'Cl2: 70,914', 'NO2: 46,0055', 'NO: 30,008', 'O3: 48,00']
