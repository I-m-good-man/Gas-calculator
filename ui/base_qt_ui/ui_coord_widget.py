...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.input_value_2 = QtWidgets.QLineEdit(parent=self.groupBox)
        self.input_value_2.setObjectName("input_value_2")
        self.mol_mass_input.addWidget(self.input_value_2)
        ...
        self.input_value = QtWidgets.QLineEdit(parent=self.groupBox)
        self.input_value.setObjectName("input_value")
        self.mass_or_volume_input.addWidget(self.input_value)
