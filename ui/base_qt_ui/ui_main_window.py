...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(932, 449))
        font = QtGui.QFont()
        ...
        self.verticalLayout_2.addWidget(self.temp_doubleSpinBox)
        ...
        self.volume_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.volume_checkbox.setObjectName("volume_checkbox")
        self.volume_choice_3.addWidget(self.volume_checkbox)
        self.volume_units_choice_3 = QtWidgets.QHBoxLayout()
        self.volume_units_choice_3.setObjectName("volume_units_choice_3")
        self.percent_checkbox_2 = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.percent_checkbox_2.setMaximumSize(QtCore.QSize(16777215, 30))
        self.percent_checkbox_2.setObjectName("percent_checkbox_2")
        self.volume_units_choice_3.addWidget(self.percent_checkbox_2)
        ...
        self.ml_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.ml_checkbox.setMaximumSize(QtCore.QSize(16777215, 30))
        self.ml_checkbox.setObjectName("ml_checkbox")
        self.volume_units_choice_3.addWidget(self.ml_checkbox, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.volume_choice_3.addLayout(self.volume_units_choice_3)
        self.horizontalLayout_2.addLayout(self.volume_choice_3)
        ...
        self.amount_of_substance = QtWidgets.QVBoxLayout()
        self.amount_of_substance.setObjectName("amount_of_substance")
        self.amount_of_substance_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.amount_of_substance_checkbox.setObjectName("amount_of_substance_checkbox")
        self.amount_of_substance.addWidget(self.amount_of_substance_checkbox)
        ...
        self.amount_of_substance.addWidget(self.line_8)
        self.mass_units_choice_4 = QtWidgets.QHBoxLayout()
        self.mass_units_choice_4.setObjectName("mass_units_choice_4")
        self.percent_checkbox_3 = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.percent_checkbox_3.setMaximumSize(QtCore.QSize(16777215, 30))
        self.percent_checkbox_3.setObjectName("percent_checkbox_3")
        self.mass_units_choice_4.addWidget(self.percent_checkbox_3, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.mass_units_choice_4.addWidget(self.line_6)
        self.mole_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.mole_checkbox.setMaximumSize(QtCore.QSize(16777215, 30))
        self.mole_checkbox.setObjectName("mole_checkbox")
        self.mass_units_choice_4.addWidget(self.mole_checkbox, 0, QtCore.Qt.AlignmentFlag.AlignBottom)
        self.amount_of_substance.addLayout(self.mass_units_choice_4)
        self.horizontalLayout_2.addLayout(self.amount_of_substance)
        ...
        self.mass_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.mass_checkbox.setObjectName("mass_checkbox")
        self.mass_choice_3.addWidget(self.mass_checkbox)
        ...
        self.percent_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.percent_checkbox.setMaximumSize(QtCore.QSize(16777215, 30))
        self.percent_checkbox.setObjectName("percent_checkbox")
        self.mass_units_choice_3.addWidget(self.percent_checkbox, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        ...
        self.g_checkbox = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.g_checkbox.setMaximumSize(QtCore.QSize(16777215, 30))
        self.g_checkbox.setObjectName("g_checkbox")
        self.mass_units_choice_3.addWidget(self.g_checkbox, 0, QtCore.Qt.AlignmentFlag.AlignBottom)
        self.mass_choice_3.addLayout(self.mass_units_choice_3)
        self.horizontalLayout_2.addLayout(self.mass_choice_3)
        ...
        self.verticalLayout_3.addWidget(self.pressure_doubleSpinBox)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 960, 301))
        ...
        self.verticalLayout_4.addWidget(self.inputs_area)
        ...
        self.verticalLayout_4.addWidget(self.M_result_label)
        ...
        self.verticalLayout_4.addWidget(self.R_result_label)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.volume_checkbox.setText(_translate("MainWindow", "V - Объем"))
        self.percent_checkbox_2.setText(_translate("MainWindow", "%"))
        self.ml_checkbox.setText(_translate("MainWindow", "мл"))
        self.amount_of_substance_checkbox.setText(_translate("MainWindow", "n - кол-во вещества"))
        self.percent_checkbox_3.setText(_translate("MainWindow", "%"))
        self.mole_checkbox.setText(_translate("MainWindow", "моль"))
        self.mass_checkbox.setText(_translate("MainWindow", "m - Масса"))
        self.percent_checkbox.setText(_translate("MainWindow", "%"))
        self.g_checkbox.setText(_translate("MainWindow", "г"))
